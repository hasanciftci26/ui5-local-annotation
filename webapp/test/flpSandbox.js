		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hcselfvariantmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hcselfvariantmanagement-display": {
								"semanticObject": "hcselfvariantmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hc.self.variantmanagement",
									"url": sap.ui.require.toUrl("hc/self/variantmanagement")
								}
							}
						}
					}
